...
@property (nonatomic, readonly, getter=isProximityRewritten) BOOL proximityRewritten;

/** Flag that options.origin was rewritten by SearchEngine based on LocationProvider data. */
@property (nonatomic, readonly, getter=isOriginRewritten) BOOL originRewritten;
